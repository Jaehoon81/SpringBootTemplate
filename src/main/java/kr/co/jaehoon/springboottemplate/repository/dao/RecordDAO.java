...
public interface RecordDAO {
    ...
    public Optional<RecordDTO> findByRecordId(@Param("recordId") Long recordId) throws IOException;

    // 특정 참가자의 특정 순서 녹음이 이미 존재하는지 확인
    public Optional<RecordDTO> findByParticipantIdAndSequence(
            @Param("participantId") Long participantId, @Param("recordSequence") Short recordSequence) throws IOException;
