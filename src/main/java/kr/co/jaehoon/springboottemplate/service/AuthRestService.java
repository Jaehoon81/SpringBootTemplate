...
//        emailService.sendEmail(user.getEmail(), subject, text);
        String htmlContent = "<!DOCTYPE html>"
                ...
                + "  <tr>"
                + "    <td style='width: 40%; padding: 8px; font-weight: bold; border: 1px solid #ccc;'>아이디:</td>"
                + "    <td style='width: 60%; padding: 8px; border: 1px solid #ccc; font-weight: bold; color: #2E86C1;'>" + maskedUsername + "</td>"
                + "  </tr>"
                + "  <tr>"
                + "    <td style='width: 40%; padding: 8px; font-weight: bold; border: 1px solid #ccc;'>임시 비밀번호:</td>"
                + "    <td style='width: 60%; padding: 8px; border: 1px solid #ccc; font-weight: bold; color: #D64541;'>" + newRandomPassword + "</td>"
                + "  </tr>"
                + "</table>"
